...
public class LPlus8 implements TaskGenerator {
    private LPlus8(){};

    private static class SingletonHolder{
        public static final LPlus8 HOLDER_INSTANCE = new LPlus8();
    }
    public static LPlus8 getInstance(){
        return LPlus8.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
