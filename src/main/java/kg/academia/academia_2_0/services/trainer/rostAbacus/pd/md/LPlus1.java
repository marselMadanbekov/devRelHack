...
public class LPlus1 implements TaskGenerator {
    private LPlus1(){};

    private static class SingletonHolder{
        public static final LPlus1 HOLDER_INSTANCE = new LPlus1();
    }
    public static LPlus1 getInstance(){
        return LPlus1.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
    public int head(int sum, int leftNum) {
        ...
        switch (sum) {
            ...
            case 8:
                if (canAdd) {
                    if(random.nextInt(10) > 7) return random.nextInt(8) + 2;
                }
                if (random.nextInt(10) > 3)
                    return 1;
        ...
        switch (sum) {
            ...
            case 1:
                if (isPlus) {
                    ...
                    if(random.nextInt(10) > 3)  return random.nextInt(5) + 4;
            ...
            case 2:
                if (isPlus) {
                    ...
                    if(random.nextInt(10) > 3)  return random.nextInt(4) + 4;
            ...
            case 4:
                if (isPlus) {
                    ...
                    if(random.nextInt(10) > 3)  return random.nextInt(2) + 4;
            ...
            case 8:
                if (isPlus) {
                    if(canAdd){
                        if(random.nextInt(10) > 7) return 2;
