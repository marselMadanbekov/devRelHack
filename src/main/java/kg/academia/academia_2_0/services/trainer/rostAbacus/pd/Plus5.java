...
public class Plus5 implements TaskGenerator {
    private Plus5(){};

    private static class SingletonHolder{
        public static final Plus5 HOLDER_INSTANCE = new Plus5();
    }
    public static Plus5 getInstance(){
        return Plus5.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
        ...
        switch (sum) {
            ...
            case 5:
                if (isPlus) {
                    ...
                    if (random.nextInt(10) > 4) return random.nextInt(5) + 5;
                    return random.nextInt(5);
