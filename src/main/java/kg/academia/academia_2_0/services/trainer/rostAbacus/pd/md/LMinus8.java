...
public class LMinus8 implements TaskGenerator {
    private LMinus8(){};

    private static class SingletonHolder{
        public static final LMinus8 HOLDER_INSTANCE = new LMinus8();
    }
    public static LMinus8 getInstance(){
        return LMinus8.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
