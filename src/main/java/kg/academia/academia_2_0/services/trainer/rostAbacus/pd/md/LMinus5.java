...
public class LMinus5 implements TaskGenerator {
    private LMinus5(){};

    private static class SingletonHolder{
        public static final LMinus5 HOLDER_INSTANCE = new LMinus5();
    }
    public static LMinus5 getInstance(){
        return LMinus5.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
