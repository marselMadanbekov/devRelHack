...
public class Minus4 implements TaskGenerator {
    private Minus4(){};

    private static class SingletonHolder{
        public static final Minus4 HOLDER_INSTANCE = new Minus4();
    }
    public static Minus4 getInstance(){
        return Minus4.SingletonHolder.HOLDER_INSTANCE;
    }
