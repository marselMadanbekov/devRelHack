...
public class LMinus2 implements TaskGenerator {
    private LMinus2(){};

    private static class SingletonHolder{
        public static final LMinus2 HOLDER_INSTANCE = new LMinus2();
    }
    public static LMinus2 getInstance(){
        return LMinus2.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
