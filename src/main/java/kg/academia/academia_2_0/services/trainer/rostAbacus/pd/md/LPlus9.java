...
public class LPlus9 implements TaskGenerator {
    private LPlus9(){};

    private static class SingletonHolder{
        public static final LPlus9 HOLDER_INSTANCE = new LPlus9();
    }
    public static LPlus9 getInstance(){
        return LPlus9.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
    ...
    public int tail(int sum, int leftNum, boolean isPlus) {
        ...
        switch (sum) {
            ...
            case 7:
                if (isPlus) {
                    if(canAdd){
                        if(random.nextInt(10) > 5)  return 9;
                    }
