...
public class Plus7 implements TaskGenerator {
    private Plus7(){};

    private static class SingletonHolder{
        public static final Plus7 HOLDER_INSTANCE = new Plus7();
    }
    public static Plus7 getInstance(){
        return Plus7.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
