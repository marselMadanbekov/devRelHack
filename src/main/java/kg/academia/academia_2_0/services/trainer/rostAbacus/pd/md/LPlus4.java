...
public class LPlus4 implements TaskGenerator {
    private LPlus4(){};

    private static class SingletonHolder{
        public static final LPlus4 HOLDER_INSTANCE = new LPlus4();
    }
    public static LPlus4 getInstance(){
        return LPlus4.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
