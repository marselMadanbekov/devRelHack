...
public class Plus6 implements TaskGenerator {
    private Plus6(){};

    private static class SingletonHolder{
        public static final Plus6 HOLDER_INSTANCE = new Plus6();
    }
    public static Plus6 getInstance(){
        return Plus6.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
