...
public class LMinus6 implements TaskGenerator {
    private LMinus6(){};

    private static class SingletonHolder{
        public static final LMinus6 HOLDER_INSTANCE = new LMinus6();
    }
    public static LMinus6 getInstance(){
        return LMinus6.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
