...
public class LMinus3 implements TaskGenerator {
    private LMinus3(){};

    private static class SingletonHolder{
        public static final LMinus3 HOLDER_INSTANCE = new LMinus3();
    }
    public static LMinus3 getInstance(){
        return LMinus3.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
