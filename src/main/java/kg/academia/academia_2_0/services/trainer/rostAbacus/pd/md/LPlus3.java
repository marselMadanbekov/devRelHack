...
public class LPlus3 implements TaskGenerator {
    private LPlus3(){};

    private static class SingletonHolder{
        public static final LPlus3 HOLDER_INSTANCE = new LPlus3();
    }
    public static LPlus3 getInstance(){
        return LPlus3.SingletonHolder.HOLDER_INSTANCE;
    }
    @Override
    public int head(int sum, int leftNum) {
        ...
        switch (sum) {
            ...
            case 4:
                if (canAdd) {
                    if(random.nextInt(10) > 6) return random.nextInt(4) + 6;
                }
                if (random.nextInt(10) > 3)
            ...
            case 7:
                if (canAdd) {
                    if(random.nextInt(10) > 1) return 3;
    ...
    public int tail(int sum, int leftNum, boolean isPlus) {
        ...
        switch (sum) {
            ...
            case 1:
                if (isPlus) {
                    if(canAdd){
                        if(random.nextInt(10) > 7)  return 9;
                    }
            ...
            case 2:
                if (isPlus) {
                    if(canAdd){
                        if(random.nextInt(10) > 7) return random.nextInt(2) + 8;
                    }
            ...
            case 3:
                if (isPlus) {
                    if(canAdd){
                        if(random.nextInt(10) > 7) return random.nextInt(3) + 7;
                    }
                    if(random.nextInt(10) > 3)  return random.nextInt(3) + 4;
                    return random.nextInt(7);
                } else return -(random.nextInt(4));
            case 4:
                if (isPlus) {
                    if(canAdd){
                        if(random.nextInt(10) > 7) return random.nextInt(4) + 6;
                    }
                    if(random.nextInt(10) > 3)  return random.nextInt(3) + 3;
            ...
            case 7:
                if (isPlus) {
                    if(canAdd){
                        if(random.nextInt(10) > 4) return 3;
                        if(random.nextInt(10) > 5) return random.nextInt(7) + 3;
                    }
